...
def main(flag, input_root, output_root, end_epoch, download):
    ...
    print('==> Building and training vae_model...')
    ...
    print('epoch %s is the best vae_model' % (index))

    print('==> Testing vae_model...')
...
def train(model, optimizer, criterion, train_loader, device, task):
    ''' training function
    :param model: the vae_model to train
...
def test(model, split, data_loader, device, flag, task, output_root=None):
    ''' testing function
    :param model: the vae_model to test
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='RUN Baseline vae_model of MedMNIST')
